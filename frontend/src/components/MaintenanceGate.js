...
const ALLOWED_PREFIXES = ['/dashboard', DASHBOARD_BASE_PATH, '/shop', '/recrutement', '/bassins', '/form', '/formulaire', '/champion', '/cuisine', '/responsables', '/commerciaux', '/rh', '/présence', '/presence', '/présence-actif', '/presence-actif', '/invités', '/invites'];
const ALLOWED_EXACT = [
  '/login',
  '/register',
  '/loading',
