...
const ALLOWED_PREFIXES = ['/dashboard', DASHBOARD_BASE_PATH, '/shop', '/recrutement', '/form', '/formulaire', '/champion', '/cuisine', '/responsables', '/commerciaux', '/présence', '/presence', '/invités', '/invites'];
const ALLOWED_EXACT = [
  '/login',
  '/register',
  '/loading',
