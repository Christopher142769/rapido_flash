...
export const translations = {
  fr: {
    ...
    commandesPage: {
      allStructures: 'Toutes les entreprises',
      structureLabel: 'Entreprise',
      noOrders: 'Aucune commande',
      noOrdersFiltered: 'Aucune commande pour cette entreprise.',
      dishLine: 'Plats',
      deliveryAddressTitle: 'Adresse de livraison',
      deliveryPhoneTitle: 'Numéro à appeler pour la livraison',
      driverInstructionsTitle: 'Indications pour le livreur',
      notProvided: '—',
    ...
    invoices: {
      ...
      subtitle: 'Reçus de paiement en ligne (FedaPay)',
    ...
    dashboardOverview: {
      ...
      pageSubtitle: 'Indicateurs et affluence des commandes pour vos entreprises.',
      ...
      refresh: 'Actualiser',
      chartTitleHour: 'Volume par heure',
      chartTitleDay: 'Volume par jour',
      chartSubtitle: 'Courbe des commandes sur la période sélectionnée',
      statusDistribution: 'Répartition par statut',
      statusCountsTitle: 'Commandes par statut',
      cityTitle: 'Chiffre d’affaires par ville',
      citySubtitle: 'Répartition des commandes et du CA selon la ville de livraison (filtre produit inclus).',
      cityColCity: 'Ville',
      cityColOrders: 'Commandes',
      cityColMontant: 'Montant',
      cityColCa: 'CA livré',
      emptyCity: 'Aucune commande géolocalisée sur cette période',
      kpiHint: 'Pour la période affichée',
      totalOrders: 'Total commandes (période)',
      kpiMontantTotal: 'Montant des commandes',
      kpiMontantTotalHint: 'Somme de toutes les commandes (hors annulées), app + Shop + Repas',
      kpiChiffreAffaires: 'Chiffre d’affaires',
      kpiChiffreAffairesHint: 'Commandes marquées comme livrées',
      kpiEntreprises: 'Entreprises',
      kpiMessages: 'Messages non lus',
      status_en_attente: 'En attente',
      status_confirmee: 'Confirmées',
      status_en_preparation: 'En préparation',
      status_en_livraison: 'En livraison',
      status_livree: 'Livrées',
      status_annulee: 'Annulées',
      loadError: 'Impossible de charger les statistiques',
      emptyChart: 'Aucune commande sur cette période',
    },
    maintenance: {
      ...
      navSection: 'Plateforme',
      activeBanner: 'Mode maintenance activé — les visiteurs voient la page d’attente',
    },
    dnsNotice: {
      title: 'Petit souci d’accès ?',
      subtitle: 'Rapido reste disponible sur un autre lien',
      defaultMessage:
        'Une difficulté temporaire peut affecter ce nom de domaine. Pas de panique : vous pouvez continuer sur notre adresse alternative, en un clic.',
      cta: 'Ouvrir Rapido',
      hint: 'Si le bouton ne répond pas, copiez le lien et ouvrez-le dans un autre navigateur ou sur un autre réseau (Wi‑Fi / données mobiles).',
      ...
      messagePlaceholder: 'Ex. : notre domaine .bj rencontre un souci DNS en ce moment…',
      save: 'Enregistrer',
      saved: 'Paramètres enregistrés',
    ...
    locationEditor: {
      ...
      browserNoGeolocation: 'La géolocalisation n’est pas prise en charge par votre navigateur.',
      geolocationDenied: 'Permission de géolocalisation refusée. Vous pouvez choisir votre position sur la carte.',
      selectPositionRequired: 'Veuillez sélectionner une position sur la carte.',
    ...
    orders: {
      ...
      cancelModalTitle: 'Annuler cette commande ?',
    ...
    checkout: {
      ...
      fedapayKeyMissing: 'Configuration FedaPay manquante (clé publique). Contactez le support.',
    ...
    store: {
      ...
      accPickTitle: 'Choisir vos accompagnements',
      accPickSubtitle: 'Sélectionnez au moins une option pour continuer.',
      accPickUniqueHint: 'Un seul choix possible pour ce produit.',
      accPickConfirm: 'Valider et continuer',
      accPickCancel: 'Annuler',
      ...
      errVariableQtyRequired: "Veuillez saisir une quantite valide pour l'unite de vente choisie avant de continuer.",
      unitLabelPiece: 'piece',
      unitLabelM3: 'm3',
      unitLabelKg: 'kg',
      unitLabelTonne: 'tonne',
      unitInputLabelM3: 'Volume (m3)',
      unitInputLabelKg: 'Poids (kg)',
      unitInputLabelTonne: 'Poids (tonne)',
      unitInputPlaceholderM3: 'Entrez le volume en m3',
      unitInputPlaceholderKg: 'Entrez le poids en kg',
      unitInputPlaceholderTonne: 'Entrez le poids en tonne',
      unitPriceAppliedBy: 'Prix unitaire applique par {{unit}}',
    ...
    chat: {
      ...
      chatsPanelTitle: 'Conversations',
      customerDetailsTab: 'Détails client',
      notesTab: 'Notes',
      notesPlaceholder: 'Notes internes (enregistrées sur cet appareil uniquement)…',
      contactWhatsapp: 'WhatsApp',
      contactCall: 'Appeler',
      contactWhatsappHint: 'Ouvrir WhatsApp avec le numéro du client',
      contactCallHint: 'Composer le numéro du client',
  ...
  en: {
    ...
    commandesPage: {
      allStructures: 'All businesses',
      structureLabel: 'Business',
      noOrders: 'No orders yet',
      noOrdersFiltered: 'No orders for this business.',
      dishLine: 'Dishes',
      deliveryAddressTitle: 'Delivery address',
      deliveryPhoneTitle: 'Phone number to call for delivery',
      driverInstructionsTitle: 'Instructions for the driver',
      notProvided: '—',
    ...
    invoices: {
      ...
      subtitle: 'Online payment receipts (FedaPay)',
    ...
    dashboardOverview: {
      ...
      navLabel: 'Overview',
      pageTitle: 'Dashboard',
      pageSubtitle: 'KPIs and order volume across your businesses.',
      periodToday: 'Today',
      period7: 'Last 7 days',
      ...
      refresh: 'Refresh',
      chartTitleHour: 'Volume by hour',
      chartTitleDay: 'Volume by day',
      chartSubtitle: 'Order trend for the selected period',
      statusDistribution: 'Breakdown by status',
      statusCountsTitle: 'Orders by status',
      cityTitle: 'Revenue by city',
      citySubtitle: 'Orders and revenue by delivery city (respects the product filter).',
      cityColCity: 'City',
      cityColOrders: 'Orders',
      cityColMontant: 'Amount',
      cityColCa: 'Delivered revenue',
      emptyCity: 'No city-tagged orders for this period',
      kpiHint: 'For the selected period',
      totalOrders: 'Total orders (period)',
      kpiMontantTotal: 'Order amounts',
      kpiMontantTotalHint: 'Sum of all orders (excl. cancelled), app + Shop + Meals',
      kpiChiffreAffaires: 'Revenue',
      kpiChiffreAffairesHint: 'Orders marked as delivered',
      kpiEntreprises: 'Businesses',
      kpiMessages: 'Unread messages',
      status_en_attente: 'Pending',
      status_confirmee: 'Confirmed',
      status_en_preparation: 'In preparation',
      status_en_livraison: 'Out for delivery',
      status_livree: 'Delivered',
      status_annulee: 'Cancelled',
      loadError: 'Could not load statistics',
      emptyChart: 'No orders in this period',
    },
    maintenance: {
      ...
      navLabel: 'Maintenance',
      navSection: 'Platform',
      activeBanner: 'Maintenance is on — visitors see the waiting page',
    },
    dnsNotice: {
      title: 'Having trouble reaching us?',
      subtitle: 'Rapido is still available on another link',
      defaultMessage:
        'This domain name may be temporarily hard to reach. No worries — you can keep using Rapido on our alternate address in one click.',
      cta: 'Open Rapido',
      hint: 'If the button does not respond, copy the link and open it in another browser or on another network (Wi‑Fi / mobile data).',
      copyLink: 'Copy link',
      copied: 'Link copied!',
      ...
      messagePlaceholder: 'E.g. our .bj domain is having a temporary DNS issue…',
      save: 'Save',
      saved: 'Settings saved',
    ...
    locationEditor: {
      ...
      browserNoGeolocation: 'Geolocation is not supported by your browser.',
      geolocationDenied: 'Location permission denied. You can pick your position on the map.',
      selectPositionRequired: 'Please select a position on the map.',
    ...
    orders: {
      ...
      cancelConfirm: 'Do you really want to cancel this order?',
    ...
    checkout: {
      ...
      fedapayKeyMissing: 'FedaPay is not configured (public key). Please contact support.',
    ...
    store: {
      ...
      productDescriptionHeading: 'Description',
      accPickTitle: 'Choose your side options',
      accPickSubtitle: 'Select at least one option to continue.',
      accPickUniqueHint: 'Only one option can be selected for this product.',
      accPickConfirm: 'Confirm and continue',
      accPickCancel: 'Cancel',
      ...
      errVariableQtyRequired: 'Please enter a valid quantity for the selected sales unit before continuing.',
      unitLabelPiece: 'piece',
      unitLabelM3: 'm3',
      unitLabelKg: 'kg',
      unitLabelTonne: 'ton',
      unitInputLabelM3: 'Volume (m3)',
      unitInputLabelKg: 'Weight (kg)',
      unitInputLabelTonne: 'Weight (ton)',
      unitInputPlaceholderM3: 'Enter m3 volume',
      unitInputPlaceholderKg: 'Enter weight in kg',
      unitInputPlaceholderTonne: 'Enter weight in tons',
      unitPriceAppliedBy: 'Unit price applied per {{unit}}',
    ...
    chat: {
      ...
      chatsPanelTitle: 'Chats',
      customerDetailsTab: 'Customer details',
      notesTab: 'Notes',
      notesPlaceholder: 'Internal notes (saved on this device only)…',
      contactWhatsapp: 'WhatsApp',
      contactCall: 'Call',
      contactWhatsappHint: 'Open WhatsApp with this number',
      contactCallHint: 'Dial the customer number',
